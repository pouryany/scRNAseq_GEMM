...
scGemms0 <- subset(t_cells, subset = immune_type == "CD8+")

Idents(scGemms0) <- "immune_type"
cell_tags <- c("CD8+")
...
ggsave("figures/Sup_gdt_allCD8.pdf",p1, width = 14, height = 10)
...
ggsave("figures/Sup_allCD8_gdT_violin.pdf",vln_eGFP1, width = 10, height = 10)
