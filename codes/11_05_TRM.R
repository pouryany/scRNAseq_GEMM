...
# # Add CD8a or CD8b
# {
#   temp_cells2 <- FetchData(scGemms0, vars  = "Cd8a")
#   temp_cells2 <- temp_cells2 >0
#   
#   temp_cells3 <- FetchData(scGemms0, vars  = "Cd8b1")
#   temp_cells3 <- temp_cells3 >0
#   
#   temp_cells2 <- temp_cells2 | temp_cells3
#   scGemms0[["my_marker"]] <- plyr::mapvalues((temp_cells2),
#                                              c(FALSE,TRUE),c("Not expressed",
#                                                              "Expressed"))
#   
...
#                                              levels = rev(order_vec))
#     
#     data_tcell[,"Cd8a or Cd8b1"] <- factor(x =  unlist(data_tcell[,"Cd8a or Cd8b1"]), levels = c("Not expressed",
#                                                                                    "Expressed"))
#     
#     
#     
#     temp_tab <- data_tcell
#     temp_tab$tot <- ("Cd8a or Cd8b1")
#     names(temp_tab) <- c("tot","cell_type_secondary","Status","value")
#     temp_tab$stage  <- stage
#     my_tab <- rbind(my_tab,temp_tab)
#     
...
# 
# 
# my_tab_early <- my_tab[my_tab$stage == "Late",]
# stack_plot_early <-  ggplot(my_tab_early, aes(x = (tot),
