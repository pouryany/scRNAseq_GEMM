...
scGemms0 <- subset(scGemms, subset = cell_type_secondary == "CD8+ TRM")
...
my_plots <- list()
  ...
  for (stage in c("Early", "Late")){
    ...
    my_plots[[paste0("TRM","_",stage)]] <- stack_plot
...
ggsave("figures/Sup_trm_gdt.pdf",p1, width = 14, height = 10)
