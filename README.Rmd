...
presented in **Tumor editing during early tumorigenesis concentrates on 
suppressing innate and adaptive immune responses to the tumor and can be
reversed by inhibiting DNA methylation**. 
...
First, you need to download the filtered scRNA-Seq dataset from NCBI GEO and 
...
| `02_02_scPlots.R`                            | Plotting clusters and cellular subclasses.  | Figures 1B, 1C and S2B  |
| `03_01_tumor_plots.R`                        | Plotting tumor clusters, associated markers, and cellular proportions.  | Figures 1F, S1, and S2 |
...
| `03_05_DEG_late_early_tumors.R`              | Differentially expressed genes in pooled tumor subgroups between late and early samples.  |  Figure 2A |
| `04_01_Tcell.R`                              | Plots relating to T and NK cells, along with associated markers. Cell proportion analysis of T and NK cells between early and late tumors. | Figure 3  |
| `04_02_immune.R`                             | Generating cell-type markers of immune cells. Plotting key markers of immune cells  | Figure S3A, marker genes for immune cells.  |
...
| `05_01_cell_cell_communication_compare.R`    | Comparison of cell-cell communication events between late and early tumors.  | Figures 4 and S4    |
...
| `06_01_Bulk_comparison_tumor.R`              | Comparison of single-cell and bulk RNA-Seq datasets.  | Figures 5J and S7  |
| `07_updated_figures.R`                       | Additional plots and analyses relating to immune cell populations.  | Figures S3 and S5A |
| `08_vln_significant.R`                       | Violin plots for functional markers across immune cell clusters.   | Figures 4D and S3D  |
| `09_Atp_genes.R`                             | Heatmaps of ATP- and metabolism-associated genes and pathways in tumors.  | Figure S2E  |
| `10_ISG.R`                                   | Defining interferon stimulated genes among differentially expressed genes in late versus early tumors.|   |
| `11_DESeq2_4T1.R`                                   | Defining differentially expressed genes in decitabine treated 4T1 cells versus untreated controls.|   |
| `12_DESeq2_B16.R`                                   | Defining differentially expressed genes in decitabine treated B16 cells versus untreated controls.|    |
