...
| `02_02_scPlots.R`                            | Plotting clusters and cellular subclasses.  | Figures 1B, 1C and Extended Data Fig. 2B  |
| `03_01_tumor_plots.R`                        | Plotting tumor clusters, associated markers, and cellular proportions.  | Figures 1D, 1E, and 1G; Extended Data Fig 1, and 2A-D |
...
| `05_01_cell_cell_communication_compare.R`    | Comparison of cell-cell communication events between late and early tumors.  | Figures 4A-B and Extended Data Fig. 4    |
...
| `06_01_Bulk_comparison_tumor.R`              | Comparison of single-cell and bulk RNA-Seq datasets.  | Figures 5J-K and Extended Data Fig. 7F  |
| `07_updated_figures.R`                       | Additional plots and analyses relating to immune cell populations.  | Extended Data Fig. 3C and 5A |
| `08_vln_significant.R`                       | Violin plots for functional markers across immune cell clusters.   | Figure 4D and Extended Data Fig. 3D  |
| `09_Atp_genes.R`                             | Heatmaps of ATP- and metabolism-associated genes and pathways in tumors.  | Extended Data Fig. S2E  |
