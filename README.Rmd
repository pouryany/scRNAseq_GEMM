...
| `02_01_clustering.R`                         | Normalizing and clustering processed scRNA-Seq data  |   |
| `02_02_scPlots.R`                            | Plotting clusters and cellular subclasses  |   |
| `03_01_tumor_plots.R`                        | Plotting tumor clusters, associated markers, and cellular proportions  |   |
| `03_02_tumor_markers.R`                      | Defining tumor markers and differentially expressed genes in specific subclusters between early and late tumors  |   |
| `03_03_cytoTracing.R`                        | CytoTrace algorithm generates cell differentiation status  |   |
| `03_04_dirchlet_tumor.R`                     | Dirichlet regression determines changes in cellular proportions between late and early tumors  |   |
| `03_05_DEG_late_early_tumors.R`              | Differentially expressed genes in pooled tumor subgroups between late and early samples  |   |
| `04_01_Tcell.R`                              | Plots relating to T and NK cells, along with associated markers. Cell proportion analysis of T and NK cells between early and late tumors. |   |
| `04_02_immune.R`                             | Generating cell-type markers of immune cells. Plotting key markers of immune cells  |   |
...
| `05_01_cell_cell_communication_compare.R`    | Comparison of cell-cell communication events between late and early tumors.  |   |
| `05_02_cell_cell_communication_secondary.R`  |   |   |
| `06_01_Bulk_comparison_tumor.R`              |   |   |
| `07_updated_figures.R`                       |   |   |
| `08_vln_significant.R`                       |   |   |
| `09_Atp_genes.R`                             |   |   |
| `10_ISG.R`                                   |   |   |
